...
.
├── apps
│   ├── macos-screening-llm-assistant    # Capture node: SwiftUI + AppKit
│   │   ├── macos-screening-llm-assistant/
│   │   └── macos-screening-llm-assistantTests/
│   └── ios-screening-llm-assistant      # (scaffold)
├── services
